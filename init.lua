----------------------------------------------------------
-- Minetest :: Offensive Flags Mod (offend_flags)
--
-- See README.txt for licensing and other information
-- Code adapted from "pride_flags" mod by Leslie E. Krause
-- Copyright (c) 2022, Nigel Farage
--
-- ./games/minetest_game/mods/offend_flags/init.lua
----------------------------------------------------------
...
local flag_list = {"godemperor", "africa", "bestkorea", "brussels", "dixie", "isis", "israel", "japan", "lgbtqqiaaplbmabmpng", "reich", "rhodesia", "soviet", "taiwan"}

minetest.register_entity( "offend_flags:wavingflag", {
	initial_properties = {
		physical = false,
		visual = "mesh",
		...
		pointable = false,
		mesh = "wavingflag.b3d",
		textures = { string.format( "offend_flags_%s.png", flag_list[1] ) },
...
print( cur_wind )
	...
	reset_texture = function ( self, flag_idx )
		...
		local texture = string.format( "offend_flags_%s.png", flag_list[ self.flag_idx ] )
...
minetest.register_node( "offend_flags:lower_mast", {
...
minetest.register_node( "offend_flags:upper_mast", {
	description = "Flag Pole",
	drawtype = "mesh",
	paramtype = "light",
	mesh = "mast_upper.obj",
	...
	on_construct = function ( pos )
		...
		local obj = minetest.add_entity( flag_pos, "offend_flags:wavingflag" )
